            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="top-menu">
                        <!-- Start Language -->
                        <ul class="language">
                            <li><a href="#"><img class="right-5" src="{{ asset('shop') }}/img/flags/gb.png" alt="#">English<i class="fa fa-caret-down left-5"></i></a>
                                <ul>
                                    <li><a href="#"><img class="right-5" src="{{ asset('shop') }}/img/flags/fr.png" alt="#">French</a></li>
                                    <li><a href="#"><img class="right-5" src="{{ asset('shop') }}/img/flags/gb.png" alt="#">English</a></li>
                                    <li><a href="#"><img class="right-5" src="{{ asset('shop') }}/img/flags/gb.png" alt="#">English</a></li>
                                </ul>
                            </li>
                        </ul>
                                    ...
                                    <div class="mini-cart-content">
                                        <div class="cart-img-details">
                                            <div class="cart-img-photo">
                                                <a href="#"><img src="{{ asset('shop') }}/img/product/total-cart.jpg" alt="#"></a>
                                            </div>
                                        ...
                                        <div class="cart-img-details">
                                            <div class="cart-img-photo">
                                                <a href="#"><img src="{{ asset('shop') }}/img/product/total-cart2.jpg" alt="#"></a>
                                            </div>
                                            <div class="cart-img-content">
                                ...
                                <li class="arrow-plus">
                                    ...
                                    <div class="cat-left-drop-menu cat-left-drop-menu-photo-contain">
                                        ...
                                        <div class="cat-left-drop-menu-left cat-left-drop-menu-photo">
                                            <a href="#"><img src="{{ asset('shop') }}/img/megamenu/vmega_blog1.jpg" alt="Product"></a>
                                        </div>
                                    </div>
                                    <!-- MEGA MENU END -->
                                </li>
                ...
                <div class="slider-area">
                    <div class="bend niceties preview-1">
                        <div id="ensign-nivoslider" class="slides">
                            <img src="{{ asset('shop') }}/img/sliders/slider-1/bg1.jpg" alt="Malias" title="#slider-direction-1"/>
                            <img src="{{ asset('shop') }}/img/sliders/slider-1/bg2.jpg" alt="Malias" title="#slider-direction-2"/>
                            <img src="{{ asset('shop') }}/img/sliders/slider-1/bg3.jpg" alt="Malias" title="#slider-direction-3"/><!--
									<img src="{{ asset('shop') }}/img/sliders/slider-1/bg4.jpg" alt="" title="#slider-direction-4"/>  -->
                        </div>
                        <!-- direction 1 -->
                ...
                <div class="sidebar-banner">
                    <div class="active-sidebar-banner">
                        <div class="single-sidebar-banner">
                            <a href="#"><img src="{{ asset('shop') }}/img/banner/1.jpg" alt="Product Banner"></a>
                        </div>
                        <div class="single-sidebar-banner">
                            <a href="#"><img src="{{ asset('shop') }}/img/banner/2.jpg" alt="Product Banner"></a>
                        </div>
                    </div>
                </div>
                <!-- END SIDEBAR-BANNER -->
            ...
            <div class="col-md-9 col-sm-9">
                    ...
                    <div class="row">
                        <div class="col-md-7 banner-box1">
                            <div class="single-product-banner">
                                <a href="#"><img src="{{ asset('shop') }}/img/banner/3.jpg" alt="Product Banner"></a>
                        ...
                        <div class="col-md-5 banner-box2">
                            <div class="single-product-banner">
                                <a href="#"><img src="{{ asset('shop') }}/img/banner/4.jpg" alt="Product Banner"></a>
                ...
                <div class="product-banner">
                    <div class="row">
                        <div class="col-md-7 banner-box1">
                            <div class="single-product-banner">
                                <a href="#"><img src="{{ asset('shop') }}/img/banner/5.jpg" alt="Product Banner"></a>
                                <div class="banner-text banner-1">
                                    <h2>ApBle 4s</h2>
                        ...
                        <div class="col-md-5 banner-box2">
                            <div class="single-product-banner">
                                <a href="#"><img src="{{ asset('shop') }}/img/banner/6.jpg" alt="Product Banner"></a>
                                <div class="banner-text banner-2">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        ...
                        <div class="payment">
                            <a href="#"><img src="{{ asset('shop') }}/img/payment.png" alt="Payment"></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-product">
                        <div class="product-images">
                            <div class="main-image images">
                                <img alt="#" src="{{ asset('shop') }}/img/product/quickview-photo.jpg"/>
                            </div>
                        </div><!-- .product-images -->
